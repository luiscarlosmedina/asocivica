    ...
    <div className="contenido">
      <Routes>
        ...
        <Route
          ...
          element={<Empresafr onDataUpdate={handleDataUpdate} />}
        />
        <Route
          path="consultar-empresas"
          element={<EmpresaVer dataUpdated={dataUpdated} />}
        />
        ...
        <Route
          ...
          element={<VerNovedades dataUpdated={dataUpdated} />}
        />
        <Route path="consultar-novedades/:idn" element={<VerDetalleNovedad />} />
        <Route path="registrar-reportes" element={<Reportes />} />
        <Route
          path="consultar-min-empleado"
          element={<EmpleadominVer dataUpdated={dataUpdated} />}
        />
      </Routes>
    </div>
  );
