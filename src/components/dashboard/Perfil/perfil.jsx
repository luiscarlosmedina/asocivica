...
export default function Perfil() {
  ...
  const fetchData = () => {
    fetch(`http://20.106.206.47/api_proyecto.github.io/api.php?apicall=readperfil&id=${user.id_em}`)
  ...
  const handleSaveChanges = () => {
    fetch(`http://20.106.206.47/api_proyecto.github.io/api.php?apicall=updateperfil`, {
      method: "POST",
      headers: {
