...
export default function Encargados({ id }) {
  ...
  const fetchData = () => {
    fetch(`https://20.106.206.47/api_sisinov/public/api/telsede/${id}`)
  ...
  const saveEnc = async (ID_En, updatedEncargado) => {
    try {
      const response = await fetch(`https://20.106.206.47/api_sisinov/public/api/encargado/${ID_En}`, {
        method: 'PUT',
        headers: {
  ...
  const deleteEnc = async (ID_En) => {
    ...
    try {
      const response = await fetch(`https://20.106.206.47/api_sisinov/public/api/encargadoestado/${ID_En}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleInsertSubmit = async () => {
    ...
    try {
      const response = await fetch(`https://20.106.206.47/api_sisinov/public/api/encargado`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
