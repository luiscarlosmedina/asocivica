...
export default function ContactoEmergencia({ id }) {
    ...
    const fetchData = () => {
        fetch(`http://20.106.206.47/api_proyecto.github.io/api.php?apicall=readcontemg&id=${id}`)
    ...
    const saveEnc = async (ID_CEm, updatedEncargado) => {
        try {
            const response = await fetch(`http://20.106.206.47/api_proyecto.github.io/api.php?apicall=updatecontemg`, {
                method: 'POST',
                headers: {
    ...
    const handleInsertSubmit = async () => {
        ...
        try {
            const response = await fetch(`http://20.106.206.47/api_proyecto.github.io/api.php?apicall=createcontemg`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
